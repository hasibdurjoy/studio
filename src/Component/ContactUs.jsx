  ...
  return (
    <div style={{ backgroundColor: "black", color: "white" }}>
      <Container style={{ padding: "100px 40px" }}>
        ...
        <h3 className="py-4 text-secondary">+1 (415) 494 7340</h3>
        ...
        <p className="py-5 text-secondary">
          Copyright ©2023 All rights reserved | 250studio | template made by{" "}
          <span className="text-light">Colorlib</span>
        </p>
      </Container>
    </div>
  );
